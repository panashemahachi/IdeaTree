...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { branch_description: @branch.branch_description, branch_name: @branch.branch_name, idea_id: @branch.idea_id, user_id: @branch.user_id }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { branch_description: @branch.branch_description, branch_name: @branch.branch_name, idea_id: @branch.idea_id, user_id: @branch.user_id }
    assert_redirected_to branch_path(assigns(:branch))
  end
